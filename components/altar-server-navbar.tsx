...
import { altarServerNavbarLinks } from "@/data/navbar-links";
    ...
    <div className="p-x-10 h-full fixed w-[280px] p-10 border-r border-gray-300/40">
      <div>
            ...
            <div className="flex gap-x-2">
              <DropdownMenu>
                ...
                <DropdownMenuContent>
                  ...
                  <DropdownMenuItem>
                    <Link href="/altar-server/account-settings">
                      Account Settings
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuSeparator />
        ...
        <ul className="mt-10 flex flex-col gap-y-4">
          {altarServerNavbarLinks.map((item, index) => {
...
export default AltarServerNavbar;
